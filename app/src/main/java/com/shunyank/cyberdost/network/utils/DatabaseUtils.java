package com.shunyank.cyberdost.network.utils;
...
import com.shunyank.cyberdost.network.callbacks.DocumentDeleteListener;
import com.shunyank.cyberdost.network.callbacks.DocumentFetchListener;
...
public class DatabaseUtils {
    ...
    public static void updateDocumentForK(Activity activity,String collectionId,
                                      String documentId,
                                      HashMap<Object,Object> data,
                                      DocumentUpdateListenerForK documentUpdateListener){
                    ...
                    activity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if(o instanceof Result.Failure){
                                ...
                                documentUpdateListener.onFailed();
                            }else {
    ...
    public static void fetchDocumentsForKotlin(Activity activity,String collectionId, List<String> searchQueries,
                                               DocumentListFetchListenerForKotlin documentListFetchListener){
        try {
            if(searchQueries==null){
                    ...
                    activity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (o instanceof Result.Failure) {
                                ...
                                documentListFetchListener.onFailed();
                            } else {
                        ...
                        database.createDocument(DATABASE_ID,collectionId, "unique()", data, new Continuation<Document>() {
                            ...
                            public void resumeWith(@NonNull Object o) {
                                ...
                                if(o instanceof Result.Failure){
                                    ...
                                    documentFindAndCreateListener.onFailed();
