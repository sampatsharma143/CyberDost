...
import com.shunaynk.megamind.network.callbacks.RealTimeConnectionListener
...
import io.appwrite.services.Service
...
class CustomRealtime(client: Client) : Service(client), CoroutineScope {


    private val job = Job()
    private var realTimeConnectionListener: RealTimeConnectionListener? =null
    ...
    fun subscribe(
        ...
        connectionListener: RealTimeConnectionListener
    ) = subscribe(
        channels = channels,
        Any::class.java,
        callback,
    ...
    fun <T> subscribe(
        ...
        realTimeConnectionListener = connectionListener
    ...
    private inner class AppwriteWebSocketListener : WebSocketListener() {
        ...
        override fun onOpen(webSocket: WebSocket, response: Response) {
            ...
            if(realTimeConnectionListener!=null){
                realTimeConnectionListener?.onOpen()
            }
            reconnectAttempts = 0
        }
        ...
        override fun onClosing(webSocket: WebSocket, code: Int, reason: String) {
            ...
            Log.e(
                this@CustomRealtime::class.java.name,
